    ...
    <div class="content">
        ...
        @if (!isset(Auth::user()->name))
            <div class="container">
                ...
                <h4 style="font-size: 1.2rem; font-weight: 600">Dihalaman dashboard dari Aplikasi Jejak Lulusan PeTIK Jombang</h4>
                <img src="{{ url('/assets/img/graduation.svg') }}" style="width:100%; margin-top: 10px; margin-bottom: 10px" alt="Kelulusan">
                <p style="margin-top: 20px">
                    Aplikasi ini dibuat untuk menampung data alumni yang lulus dari PeTIK Jombang. Riwayat temen-temen saat ini sedang kuliah? Sedang mencari pekerjaan? Sedang bekerja? Atau bahkan kerja dan kuliah?
                </p>
